...
import { getUserWithRecipes, boughtRecipesByUser } from '../../APICalls.js'
    ...
    return (
      <div className="RecipeBook">
        ...
        <section className='my-recipe-section'>
          ...
          {allRecipes[0] || <h4>You haven't uploaded any recipes</h4>}
          </section>
          <section className='purchased-recipe-section'>
          <h1>Recipes you have purchased: </h1>
          {allRecipes[1] || <h4>You haven't purchased any recipes</h4>}
        </section>
      </div>
    );
  }
